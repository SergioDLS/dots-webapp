...
const NODE_SIZE = 168; // px – each node placeholder height (circle + label + gap)
...
export default function LevelSection({
  ...
  const totalH =
    list.length > 0 ? list.length * (NODE_SIZE + ROW_GAP) - ROW_GAP : 0;
    ...
    >
      ...
      {list.length === 0 ? (
        ...
        <div
          ...
          style={{ maxWidth: 520, height: totalH }}
        >
          {/* SVG connector line */}
          {points.length >= 2 && (
            <svg
